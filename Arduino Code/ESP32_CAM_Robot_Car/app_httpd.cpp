    ...
    <br/>
          ...
          <section id="buttons">
                ...
                <div id="controls" class="control-container">
                  <table>
                  <tr><td align="center"><button class="button button6" id="get-still">Image</button></td><td align="center"><button id="toggle-stream">Open</button></td><td></td></tr>
                  ...
                  <td align="center"><button class="button button2" id="stop" onclick="fetch(document.location.origin+'/control?var=car&val=3');">STOP</button></td>
